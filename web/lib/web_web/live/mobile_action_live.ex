defmodule WebWeb.MobileActionLive do
  ...
  def render(assigns) do
    ...
    <div id="wallet" phx-hook="Wallet" class="flex flex-col items-center justify-center min-h-[70vh] gap-4 text-center px-6">
      ...
      <div :if={@status in [:connecting, :running]} class="flex flex-col items-center gap-3">
      ...
      <div :if={@status == :done} class="flex flex-col items-center gap-2">
      ...
      <div :if={@status == :error} class="flex flex-col items-center gap-2">
